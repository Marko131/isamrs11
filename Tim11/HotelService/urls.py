...
from .views import hotels, searched_hotels, search_rooms, hotel_detail, find_rooms, reserve_room, search_rooms_after_reservation, reserve_quick_room, rate_room
urlpatterns = [
