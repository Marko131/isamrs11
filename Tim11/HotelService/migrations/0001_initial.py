    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flight_reservation', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='FlightService.FlightReservation')),
            ],
        ),
        migrations.CreateModel(
            name='Room',
        ...
        migrations.AddField(
            ...
            name='room',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='HotelService.Room'),
        ),
        migrations.AddField(
            model_name='hotelreservation',
            name='user',
